              ...
              <div className="p-3 flex flex-col justify-between">
                <div className="p-4 mx-auto text-coal font-poppins text-sm">
                  ...
                  <p>
                    ...
                    including laser hair removal, medi-facials, and other
                    skincare treatments. By accessing our website or using our
                  ...
                  <div className="space-y-4 mt-4">
                    <section>
                      ...
                      <ul className="list-disc space-y-2 text-sm">
                        ...
                        <li>
                          ...
                          legal parental/guardian consent.
                        </li>
                        <li>
                          Pureskyn reserves the right to update, modify, or
                          change these Terms at any time without prior notice.
                          Your continued use of the website and services
                    ...
                    <section>
                      ...
                      <ul className="list-disc space-y-2">
                        <li>
                          Pureskyn provides home care services, including but
                          not limited to laser hair removal, medi-facials, and
                          skincare treatments.
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          medical conditions, or non-compliance with our
                          policies.
                        </li>
                        <li>
                          Clients must disclose any medical conditions,
                          allergies, or skin sensitivities before availing of
                          any service.
                        </li>
                        <li>
                          Services are performed based on industry standards,
                          and while we aim for the best results, individual
                          results may vary.
                        </li>
                        <li>
                      ...
                      <ul className="list-disc space-y-2">
                        ...
                        <li>
                          ...
                          are not responsible for typographical errors in
                          pricing.
                        </li>
                        <li>
                        ...
                        <li>
                          Users must follow the provided instructions for
                          product usage. Pureskyn is not liable for any adverse
                          effects resulting from incorrect usage.
                        </li>
                      </ul>
                    </section>
                    ...
                    <section>
                      ...
                      <ul className="list-disc space-y-2">
                        <li>
                          Payments for services and products must be made in
                          full at the time of booking or purchase.
                        </li>
                        <li>
                        ...
                        <li>
                          Refunds for product purchases will only be processed
                          if the product is defective or incorrect. Refund
                          requests must be made within [insert number] days of
                          purchase.
                        </li>
                      </ul>
                    </section>
                    ...
                    <section>
                      ...
                      <ul className="list-disc space-y-2">
                        <li>
                          Clients must notify us at least 24 hours in advance
                          for cancellations or rescheduling of appointments.
                        </li>
                        <li>
                          Last-minute cancellations or no-shows may be subject
                    ...
                    <section>
                      ...
                      <ul className="list-disc space-y-2">
                        ...
                        <li>
                          We do not guarantee specific results from our
                          services, as results may vary from person to person.
                        </li>
                        <li>
                          Pureskyn is not liable for any indirect, incidental,
                    ...
                    <section>
                      ...
                      <ul className="list-disc space-y-2">
                        ...
                        <li>
                          ...
                          except as required to fulfill our services or legal
                          obligations.
                        </li>
                        <li>
                          Users consent to receive promotional communications
                          from Pureskyn, which they can opt out of at any time.
                        </li>
                      </ul>
                    </section>
                    ...
                    <section>
                      ...
                      <ul className="list-disc space-y-2">
                        <li>
                          ...
                          images, logos, and branding, is the property of
                          Pureskyn and may not be copied, reproduced, or used
                          without prior written consent.
                        </li>
                        <li>
                          Unauthorized use of any Pureskyn materials may result
                          in legal action.
                        </li>
                      </ul>
                    </section>
                    ...
                    <section>
                      ...
                      <ul className="list-disc space-y-2">
                        <li>
                          ...
                          access to its services for users who violate these
                          Terms and Conditions.
                        </li>
                        <li>
                          Termination may occur without prior notice if a user
                          engages in fraudulent activity, misconduct, or any
                    ...
                    <section>
                      ...
                      <p>
                        ...
                        us at: Email: mail@test.com Phone: +91-8789899871
                      </p>
                    </section>
