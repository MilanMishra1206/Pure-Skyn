      ...
      {type && (
        <div className="text-justify">
          ...
          >
            ...
            >
              <div className={`${!isTablet ? "w-50" : "w-full"}`}>
                <p>
                  Derma™ Infusion Facial is a unique and innovative microneedling system
                ...
                <p>
                  ...
                  Derma Infusion Facial uses vacuum so that the microneedles penetrate to a
            ...
            >
              ...
              >
                <div className="!text-2xl font-bold">
                  What conditions does Derma Infusion Facial treatment solve?
                </div>
                <div className="flex flex-col">
                  <p>
                    Derma Infusion Facial is a very safe and effective treatment for various
            ...
            >
              <div className="flex flex-col ml-0 xl:!ml-5">
                <div className="!text-2xl font-bold mb-2">
                  How Does Derma Infusion Facial Work?
                </div>
                <p>
          ...
          >
            <FadedLineBreak />
            <BeforeAfterCarousel
              carouselContent={beforeAfterCarouselContent?.["Derma Infusion Facial"]}
            />
            <FadedLineBreak />
