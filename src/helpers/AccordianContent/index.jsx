export const LHRAccordianContent = [
  {
    id: 1,
    title: "IS IT POSSIBLE TO GET LASER HAIR REMOVAL ON DARKER SKIN?",
    content: `Yes, the lasers we use are very effective for darker skin and hair colours. The best laser for dark-skinned clients is the Nd: YAG.This is because the Nd: YAG hair removal laser has a different wavelength. 
                     It leaves the skin undamaged and is more precise in its penetration of hair follicles. 
                     Our lasers allow us to treat all skin types without any issues.`,
  },
  {
    id: 2,
    title: "WHAT ARE THE BEST SKIN TONES TO USE FOR LASER HAIR REMOVAL?",
    content: `We use medical-grade lasers to treat all skin tones. There are two different laser machines that we can use to achieve safe results for different skin tones. Here at CoLaz clinic, we start each treatment consultation using the Fitzpatrick Classification Scale to identify your skin tone and recommend the appropriate range of machines.
                      ...
                      Our Alex laser is suitable for people who have fair skin. The Yag laser is ideal for people with darker skin.`,
  },
  {
    id: 3,
    title: "HOW DOES LASER HAIR REMOVAL WORK?",
    content: `The laser works by targeting the dark pigment in the hair follicle. 
                      This process is called selective photothermolysis and can be used for any skin tone but offers more excellent success rates on medium to darker tones.`,
  },
  {
    id: 4,
  ...
  {
    id: 5,
    title: "IS LASER HAIR REMOVAL SAFE FOR PRIVATE PARTS?",
    content: `Yes, laser hair removal is safe for men's private parts. We have treated thousands of clients with excellent results. 
                        Our ND: YAG medical grade laser machine can be adjusted to suit each client skin tone and hair follicle. Other lasers used to remove hair have a shorter wavelength and are not as effective. The Nd: YAG laser has a longer wavelength and is more selective in treating hair. It leaves the surrounding skin tissue undamaged.`,
  },
];

export const laserHairRemovalFaq = [
  ...LHRAccordianContent,
  {
    id: 6,
    title: "DOES LASER HAIR REMOVAL HURT?",
    content: `Laser hair removal does not hurt. It may feel like a rubber band flicking on your skin for a few seconds as the laser goes over the area being treated, but there is no pain involved with this procedure.
                    We use numbing cream to help reduce any discomfort during treatment.`,
  },
  {
    id: 7,
    title: "WHAT RESULTS CAN I EXPECT?",
    content: `The number of treatments you need will depend on the area being treated. For example, for the men's beard area, you will need more treatments than chest treatment. Clients are satisfied with the results after six to eight laser hair removal sessions, but this is an individual choice as some clients see results quicker than others.
                    The hair also grows in different cycles, so it is essential to know which phase your hair follicles are currently in when planning treatments for the best results possible`,
  },
];
...
export const mediFacialAccordianContent = [
  {
    id: 1,
    title: "What are the risks associated with Medifacials?",
    content: `There are hardly any risks associated with Medifacials. Even if there are any, it will go away on its own or can be treated easily. Here are some possible side effects you may experience - 
              > Breakouts
              > Minor swelling
              > Increased translucence
              > Redness
              > Rare cases of blistering, pigmentation, or bleeding`,
  },
  {
    id: 2,
    title: "How to minimize the risk associated with Medifacials?",
    content: `Follow the guidelines instructed by us on how to take good care of the skin after the treatment. Having an experienced dermatologist will make things easy for you and also reduce the risk factors. Dr. Renu offers one of the best Medifacial treatments in Bengaluru. But apart from picking the right doctor, here are few things you can do to minimize the risks:
                > Use sun protection cream regularly after the treatment.
                > Stay hydrated; drink at least eight glasses of water daily.
                > Use mild soaps and cleanse your face gently for five days after treatment.`,
  },
  {
    id: 3,
    title:
      "Is there anything I should keep in mind before I come to the treatment?",
    content: `  > Dont shave the area to be treated two days before the treatment.
                ...
                > Mention your medications and allergies in detail to us.`,
  },
  {
    id: 4,
    title: "What is the difference between HydraFacial and MediFacial?",
    content: `One of the main differences between HydraFacial and MediFacial is the level of intensity. HydraFacial is a gentler treatment that is suitable for all skin types, while MediFacial is a more intensive treatment that is typically recommended for patients with specific skin concerns.`,
  },
  {
    id: 5,
    title: "How long does a medi facial last?",
    content: `The standard duration of a Medifacial procedure is 45 to 90 minutes. It will take around two to three days for the skin to hydrate and appear supple and nearly 30 to 45 days for the cells to completely regenerate. After the Medifacial, you can have redness, which is quite common.`,
  },
];

export const mediFacialFaq = [
  ...mediFacialAccordianContent,
  {
    id: 6,
    title: "Is Medifacial safe?",
    content: `Yes, Hydra-Medi Facial is safe for all skin types as it helps hydrate and nourish the skin with the benefits of hyaluronic acid and Vitamin C.`,
  },
];
